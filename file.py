...
class Window(Frame):
	...
	def init_window(self):
		...
		quitButton.place(height = 50, width = 200,x = 200, y = 680)

		quitButton = Button(self, text="Bomb Detection", command = self.Program, bg = "#ff3300")
		...
		file.add_command(label = 'Bomb Detection', command = self.Program)
